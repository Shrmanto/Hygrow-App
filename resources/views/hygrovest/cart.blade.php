...
<body class="js">
	...
	<div class="shopping-cart section">
		<div class="container">
					...
					<table class="table shopping-summery">
						<thead>
							<tr class="main-hading">
								<th>Invest Name</th>
								<th>Images</th>
								<th class="text-center">Status WithDraw</th>
								<th class="text-center">Harga</th> 
								<th class="text-center">Description</th> 
							</tr>
						</thead>
						<tbody>
							@foreach ($getDompet as $item)
							<tr>
								<td>
									<p class="product-name"><a href="">{{$item->invest_name}}</a></p>
								</td>
								<td class="image" data-title="No"><img src={{asset($item->images)}} alt="#"></td>
								<td class="text-warning text-uppercase fw-bold">{{$item->status_wd}}</td>
			...
			<div class="row">
				<form action="{{url('/dompet-invest/'.$getDetailDompet->id.'')}}" method="POST" enctype="multipart/form-data">
				@csrf
				@method('patch')
					<div class="col-12">
						<!-- Total Amount -->
						<div class="total-amount">
							@foreach ($getDompet as $item)
								...
								<input type="hidden" name="status_wd" value="{{$item->status_wd}}" id="">								
							@endforeach
							<div class="row">
								<div class="">
									<div class="right">
										...
										<div class="button5">
											<button type="submit" onclick="confirm('confirm wd ?')" class="btn">Bayar Invest</button>
										</div>
									</div>
								</div>
							</div>
	...
	<a href="https://api.whatsapp.com/send/?phone=6282555832517&text&type=phone_number&app_absent=0" class="btn btn-info">
		<i class="fa fa-wa"></i>
		Lanjutkan Pembayaran Ke WA</a>
    <script>
