					...
					<div class="col-lg-2 col-md-3 col-12">
						<div class="right-bar">
							...
							<div class="sinlge-bar">
								<a href="{{url('/get-dompet')}}" class="single-icon"><i class="fa fa-heart-o" aria-hidden="true"></i></a>
							</div>
							<div class="sinlge-bar">
					...
					<div class="row">
						<div class="col-lg-3">
							<div class="all-category">
								<h3 class="cat-heading"><i class="fa fa-bars" aria-hidden="true"></i>HyGrovest</h3>
									</li>
							</div>
						</div>
									...
									<div class="navbar-collapse">	
										<div class="nav-inner">	
											<ul class="nav main-menu menu navbar-nav">
													...
													<li><a href="/hygromart">HyGMart</a></li>
									...
									<div class="tab-single">
										<div class="row">
											...
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<form action="{{url('/get-invest/'.$item->id.'')}}" method="POST" enctype="multipart/form-data">
													@csrf
													@method('post')
														...
														<div class="product-img">
															...
															<div class="button-head">
																...
																<div class="product-action-2">
																	<button class="btn btn-success" title="Add to cart" type="submit">Make an Invest</button>
																	<input type="hidden" name="investation_id" value="{{$item->id}}" class="ml-2 col-2">
																	<input type="hidden" name="user_id" value="{{Auth::user()->id}}" class="ml-2 col-2">
																	<input type="hidden" name="status_payment" value="belum dibayar" class="ml-2 col-2">
																	<input type="hidden" name="status_wd" value="belum wd" class="ml-2 col-2">
																</div>
															</div>
														</div>
														<div class="product-content">
															<h3><a href="product-details.html">{{$item->invest_name}}</a></h3>
															<div class="product-price d-flex">
																<span >@currency($item->price)</span>
															</div>
															<div class="product-price d-flex">
																<span >Invest Available : {{$item->stock}}</span>
															</div>
															<div class="product-price d-flex">
																<span >Description : {{$item->description}}</span>
															</div>
															<div class="product-price d-flex">
																<span >Kontrak : {{$item->contract}} Bulan</span>
															</div>
															<div class="product-price d-flex">
