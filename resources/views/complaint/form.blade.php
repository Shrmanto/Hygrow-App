        ...
        <div class="modal-content">
            <form method="POST" class="form-horizontal" data-toggle="validator">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="defaultModalLabel">Partners Data Account</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col mb-3">
                            <label for="isi" class="form-label">Complain</label>
                            <input type="text" id="isi" name="isi" class="form-control" autofocus
                                required />
                        </div>
                    </div>
